 ...
 */
@WebServlet("/SubDealerRegister")
public class SubDealerRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String query="insert into subdealerregister(fname,lname,address,phone,email,password) values (?,?,?,?,?,?)";
...
else
{
	 out.println("<script type=\"text/javascript\">");
	   ...
	   out.println("location='subdealerregister.jsp';");
	   out.println("</script>");
}
	} catch (Exception e) {
			e.printStackTrace();
