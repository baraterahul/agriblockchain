            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul>
                 ...
                 <li><a href="farmerlogin.jsp">Farmer Login</a></li>
                   <li><a href="farmerregister.jsp">Farmer Register</a></li>
                </ul>
                <!-- Search Icon -->
             ...
             <div class="form-label-group">
              <label for="inputEmail">First Name</label>
               ...
               <label for="inputEmail">Phone No</label>
                <input type="tel" id="inputEmail" name="phone"  class="form-control" placeholder="Enter PhoneNo" pattern="[0-9]{3}[0-9]{3}[0-9]{4}"
       required >
