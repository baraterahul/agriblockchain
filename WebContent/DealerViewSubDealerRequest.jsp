...
<body >
  ...
  <!-- ##### Hero Area Start ##### -->
  <div class="container">
  <h2>Dealer View SubDealer Request</h2>
  <p></p>  
  ...
  String mail=(String)session1.getAttribute("DealerEmail");
						...
						String qry = "select * from subdealersendreqtodealer where dealerMail=?";
    ...
    <tbody id="myTable" >
      <% 
								 ...
								 <tr>
									...
									<td><a href="SubdealerPurchaseProduct.jsp?id=<%=rset.getString(1)%>">Accept</a></td>
