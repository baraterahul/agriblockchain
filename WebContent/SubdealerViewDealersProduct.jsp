...
<body >
  ...
  <!-- ##### Hero Area Start ##### -->
  <div class="container">
  <h2>SubDealer Purchase Product</h2>
  <p></p>  
...
/*   HttpSession session1=request.getSession(false);
  String mail=(String)session1.getAttribute("DealerEmail"); */
						...
						String qry = "select * from dealerpriceblock ";
  ...
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
      <th>Id</th>
  <!--  id, FarmerData, FarmerName, cropname, cropquantity, cropFRP, totalprice, previousHash, currentHash, timeStampp, dealerMail -->
        <th>Farmer Data</th>
        <th>FarmerEmail</th>
        <th>cropname</th>
        <th>cropquantity In Quintal</th>
        <th>cropFRP</th>
         <th>TotalPrice</th>
         <th>Purchase</th>
								 ...
								 <tr>
									...
									<th><%=rset.getString(5)%></th>
									 <th><%=rset.getString(6)%></th>
									  ...
									  <td><a href="SubdealerRequestProduct.jsp?id=<%=rset.getString(1)%>">Request</a></td> 
