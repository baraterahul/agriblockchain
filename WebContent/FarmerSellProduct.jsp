          ...
          <nav class="classy-navbar justify-content-between" id="famieNav">
            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
               ...
               <li><a href="#">Add crop Details</a></li>
...
<input type="hidden" name="farmerEmail" value="<%=mail%>"> 
 <!--  farmerName,FarmerEmail,FertilizerEmail,Seed,seed_type,fertilize_1,fertilize_2,Pesticide_1,Pesticide_2 -->
  <%HttpSession see=request.getSession(false);
  String crop=(String)see.getAttribute("Seed");
  String Stype=(String)see.getAttribute("seed_type");
   String fertilize_1=(String)see.getAttribute("fertilize_1");
    String fertilize_2=(String)see.getAttribute("fertilize_2");
     String Pesticide_1=(String)see.getAttribute("Pesticide_1");
     String Pesticide_2=(String)see.getAttribute("Pesticide_2");
     %>
              <div class="form-label-group">
               <label for="inputEmail">Enter Crop Name</label>
              <input type="text" id="" name="cropname" value="<%=crop%>"class="form-control" placeholder="Enter location" required>
              </div>
              ...
              <label for="inputPassword">Crop Quality</label>
                 <input type="text" id="" name="cropquality" value="<%=Stype%>"class="form-control" placeholder="Enter location" required>
	...
	%> 
             ...
             <% 
              ...
              <input type="hidden" name="FarmerData" value="Fertilize:<%=fertilize_1%>,Fertilize:<%=fertilize_2%>,Pesticide:<%=Pesticide_1%>,Pesticide:<%=Pesticide_2%>">
