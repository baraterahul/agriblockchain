...
<body >
  ...
  <!-- ##### Hero Area Start ##### -->
  <div class="container">
  <h2>Sub Dealer View Customer Request</h2>
  <p></p>  
  ...
  String mail=(String)session1.getAttribute("SubDealerEmail");
  
						String qry = "select * from customerrequestsubdealer where SubDealerMail=?";
    ...
    <tbody id="myTable" >
      <% 
								 ...
								 <tr>
									...
									<td><a href="SubdealerSellProductToCustomer.jsp?id=<%=rset.getString(1)%>">Accept</a></td>
