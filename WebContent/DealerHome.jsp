            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                ...
                <li><a href="ViewFarmerReq.jsp">View Farmer Request</a></li>
                   <li><a href="DealerViewSubDealerRequest.jsp">View Sub Dealer Request</a></li>
                 <li><a href="dealerregister.jsp"></a></li>
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Dealer Sign In</h5>
            <form class="form-signin" action="DealerLogin" method="post">
