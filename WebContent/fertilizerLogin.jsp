              ...
              <div class="classynav">
                <ul>
                  <li class="active"><a href="index.jsp">Home</a></li>
                   ...
                   <li><a href="fertilizerLogin.jsp">Login</a></li>
                   <li><a href="fertilizerRegister.jsp">Register</a></li>
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Fertilizer Login</h5>
            <form class="form-signin" action="FertilizerLoginServlet" method="post">
