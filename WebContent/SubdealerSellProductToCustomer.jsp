  ...
  <div class="hero-area">
    <div class="">
      ...
      <%
		...
		if (id != null) {
			String str = "select * from customerrequestsubdealer where id=?";
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form action="CustomerBlock"  method="post" class="form-signin" >
...
cropName, cropQuantity, Quality, cropFRP, totalprice, Previoushashh, timestampp -->
 ...
 <input type="hidden" name="Subid" value="<%=rs.getString(1)%>">
 <input type="hidden" name="FarmerData" value="<%=rs.getString(2)%>">
  
 <input type="hidden" name="Fid" value="<%=rs.getString(7)%>">
  <input type="hidden" name="SubDealerMail" value="<%=rs.getString(8)%>">
    <input type="hidden" name="CustomerMail" value="<%=rs.getString(9)%>">
              ...
              <label for="inputPassword">Crop Quantity</label>
               <input type="text" id="value1" name="cropQuantity" value="<%=rs.getString(5)%>" class="form-control" placeholder="Enter Quantity in Quintal (100kg=1Quintal)">
              </div>
              
              <div class="form-label-group">
              <label for="inputPassword">Crop Quality</label>
                <input type="text" id="inputPassword" name="Quality" value=<%=rs.getString(6)%>  class="form-control" placeholder="Enter location">
                
              </div>
               <%              String qry = "select * from customerfrprate";
