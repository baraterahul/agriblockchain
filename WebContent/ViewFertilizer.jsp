 ...
 <a href="farmerhome.jsp" class="previous">&laquo; Back</a>
  ...
  <a href="FarmerLogout" class="previous">&laquo; Logout</a>
			 ...
			 <%
						...
						String qry = "select * from fertilizerregister";
  ...
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
      <th>Id</th>
        <th>Fertilizer FirstName</th>
        <th>Fertilizer LastName</th>
       <th>Address</th>
        <th>Phone</th>
         <th>Email</th>
        <th>Purchase</th>
    ...
    <tbody id="myTable">
     <% 
								 ...
								 <tr>
									...
									<td><a href="PurchaseSeeds_Fertilizer.jsp?id=<%=rset.getString(1)%>">Purchase</a></td>
