    ...
    <div class="row">
      <div class="col-sm-6 col-md-9 col-lg-6 mx-auto">
        <div class="card card-signin my-7">
          <div class="card-body">
            <h5 class="card-title text-center">SubDealer Register Here</h5>
            <form class="form-signin" action="SubDealerRegister" method="post">
             <div class="form-label-group">
                <input type="text" id="inputEmail" name="fname" class="form-control" placeholder="Enter First Name" required autofocus>
                <label for="inputEmail">First Name</label>
              </div>
               <div class="form-label-group">
                <input type="text" id="inputEmail" name="lname" class="form-control" placeholder="Enter Last Name" required autofocus>
                <label for="inputEmail">Last Name</label>
              </div>
               <div class="form-label-group">
                <input type="text" id="inputEmail" name="address" class="form-control" placeholder="Enter Address" required autofocus>
                <label for="inputEmail">Address</label>
              </div>
               <div class="form-label-group">
                <input type="text" id="inputEmail" name="phone"  class="form-control" placeholder="Enter PhoneNo" required autofocus>
