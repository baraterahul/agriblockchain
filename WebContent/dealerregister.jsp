            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul>
                 ...
                 <li><a href="subdealerlogin.jsp">Login</a></li>
                   <li><a href="subdealerregister.jsp">Register</a></li>
                </ul>
                <!-- Search Icon -->
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                               <form action="DealerRegisterServlet" method="post">
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Dealer First Name *" Name="fname"value="" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Dealer Last Name *" name="lname" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Perment Address *"  name="address" value="" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control"  placeholder="Market Name*" name="mnane" value="" />
                                        </div>
                                       <div class="form-group">
                                            <input type="text" class="form-control"  placeholder="Market Address*" name="maddress" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="City *" name="city" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control"  placeholder="Enter State Name" name="state" value="" />
                                        </div>
                                        <div class="form-group">
