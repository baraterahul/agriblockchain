...
/*   HttpSession session1=request.getSession(false);
  ...
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
      <th>Id</th>
    <!--    id, fname, lname, address, phone, email, mname, maddress, city, state, password -->
        <th>First Name</th>
        <th>Last Name</th>
        <th>Address</th>
        <th>Phone</th>
      ...
      <% 
								 ...
								 <tr>
									...
									<th><%=rset.getString(10)%></th>
									 <td><a href="SubDealerFrp.jsp?id=<%=rset.getString(1)%>">View</a></td>
									 <td><a href="SubdealerViewDealersProduct.jsp?id=<%=rset.getString(1)%>">Purchase</a></td>
