  ...
  <div class="hero-area">
    <div class="">
      ...
      <%
		...
		if (id != null) {
			String str = "select * from dealerpriceblock where id=?";
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form action="SubDealerSendRequestToDealer"  method="post" class="form-signin" >
            <!--  id, FarmerData, FarmerName, cropname, cropquantity, 
            cropFRP, totalprice, previousHash, currentHash, timeStampp, dealerMail -->
            
           

                 <div class="form-label-group">
              <!--  <label for="inputEmail">Id</label> -->
                <input type="hidden" id="inputPassword" name="fid" value="<%=rs.getString(1)%>" class="form-control"  >
              </div>
              <div class="form-label-group">
             ...
             <!--  <label for="inputPassword">FarmerEmail</label> -->
              ...
              <label for="inputPassword">crop Quality</label>
               <input type="text" id="inputPassword" name="cropquality" value="<%=rs.getString(12)%>" class="form-control" placeholder="Enter Quantity in Quintal (100kg=1Quintal)">
              </div>
            ...
            <!--   <label for="inputPassword">totalprice</label> -->
              ...
              <div class="form-label-group">
              <label for="inputPassword">DealerMail</label>
               <input type="text" id="inputPassword" name="dealerMail" value="<%=rs.getString(11)%>" class="form-control" placeholder="Enter Quantity in Quintal (100kg=1Quintal)">
              </div>
