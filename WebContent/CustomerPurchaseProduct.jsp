 ...
 <a href="CustomerHome.jsp" class="previous">&laquo; Back</a>
  ...
  <a href="CustomerLogout" class="previous">&laquo; Logout</a>
			 ...
			 System.out.print(id);
						...
						String qry = "select * from subdealerblock where id='"+id+"'";
  ...
  <table class="table table-bordered table-striped">
    <thead>
      ...
      <th>Id</th>
        ...
        <th>Crop Name</th>
       <th>Quantity</th>
        <th>Crop Frp SubDealer Purchase</th>
         <th>Total Price</th>
        <th>Purchase</th>
    ...
    <tbody id="myTable">
     <% 
								 ...
								 <tr>
									...
									<td><a href="CustomerRequestSubdealer.jsp?id=<%=rset.getString(1)%>">Request</a></td> 
